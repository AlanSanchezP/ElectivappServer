...
from electivapp.apps.eventos.api import EventosListAPI, RegistrarAsistenciaQRAPI, RegistrarAsistenciaAPI
...
urlpatterns = [
    ...
    path("api/eventos/asistencia/form", view=RegistrarAsistenciaAPI.as_view()),
